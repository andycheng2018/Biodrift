...
public class MapGenerator : MonoBehaviour
{
	...
	public Biome biome;
	public enum Biome { Desert, BeechForest, MapleForest, ConiferousForest, Savannas, Tundra, FlowerFields, Arctic };
    ...
    public void CheckBiome()
	{
        ...
        if (biome == Biome.Desert)
        {
            ...
            {
                materials[i].material.SetColor("_Color", materials[i].desert);
            }
        }
        else if (biome == Biome.BeechForest)
        {
            for (int i = 0; i < materials.Length; i++)
            {
                materials[i].material.SetColor("_Color", materials[i].beechForest);
            }
        }
        else if (biome == Biome.MapleForest)
        {
            for (int i = 0; i < materials.Length; i++)
            {
                materials[i].material.SetColor("_Color", materials[i].mapleForest);
            }
        }
        else if (biome == Biome.ConiferousForest)
        {
            for (int i = 0; i < materials.Length; i++)
            {
                materials[i].material.SetColor("_Color", materials[i].coniferousForest);
            }
        }
        else if (biome == Biome.Savannas)
        {
            for (int i = 0; i < materials.Length; i++)
            {
                materials[i].material.SetColor("_Color", materials[i].savannas);
            }
        }
        else if (biome == Biome.Tundra)
        {
            for (int i = 0; i < materials.Length; i++)
            {
                materials[i].material.SetColor("_Color", materials[i].tundra);
            }
        }
        else if (biome == Biome.FlowerFields)
        {
            for (int i = 0; i < materials.Length; i++)
            {
                materials[i].material.SetColor("_Color", materials[i].flowerFields);
            }
        }
		...
		ambientMusic.clip = biomes[(int)biome].ambientSound;
...
public struct Materials
{
	...
	public Color desert;
	public Color beechForest;
	public Color mapleForest;
	public Color coniferousForest;
	public Color savannas;
	public Color tundra;
	public Color flowerFields;
	public Color arctic;
}
